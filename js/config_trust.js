/**
 * @file config_trust.js
 * @description 信頼テーマ用のオフィス設定オーバーライド。
 *              基本設定を上書きし、nanobanana2社会保険労務士事務所の情報を設定します。
 */

(function() {
  if (typeof OFFICE_CONFIG_DEFAULTS !== 'undefined') {
    OFFICE_CONFIG_DEFAULTS.officeName = "nanobanana2社会保険労務士事務所";
    OFFICE_CONFIG_DEFAULTS.email = "info@trust.nanobanana2-sr.example.com";
